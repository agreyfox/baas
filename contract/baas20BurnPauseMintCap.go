...
func (_Baas20 *Baas20Caller) Cap(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Baas20.contract.Call(opts, out, "cap")
	return *ret0, err
}
...
//
// Solidity: function cap() view returns(uint256)
func (_Baas20 *Baas20Session) Cap() (*big.Int, error) {
	return _Baas20.Contract.Cap(&_Baas20.CallOpts)
}

// Cap is a free data retrieval call binding the contract method 0x355274ea.
//
// Solidity: function cap() view returns(uint256)
func (_Baas20 *Baas20CallerSession) Cap() (*big.Int, error) {
	return _Baas20.Contract.Cap(&_Baas20.CallOpts)
}

...
// FilterTransactionMemo is a free log retrieval operation binding the contract event 0x123392ef4dfc825252c018e5fdcbb56bd895e4f681eba5e936e164009a05f435.
//
// Solidity: event transactionMemo(uint256 indexed tokenId, uint256 indexed blockNumber, string memo)
func (_Baas721 *Baas721Filterer) FilterTransactionMemo(opts *bind.FilterOpts, tokenId []*big.Int, blockNumber []*big.Int) (*Baas721TransactionMemoIterator, error) {
	...
	logs, sub, err := _Baas721.contract.FilterLogs(opts, "transactionMemo", tokenIdRule, blockNumberRule)
	if err != nil {
		return nil, err
	}
...
// WatchTransactionMemo is a free log subscription operation binding the contract event 0x123392ef4dfc825252c018e5fdcbb56bd895e4f681eba5e936e164009a05f435.
//
// Solidity: event transactionMemo(uint256 indexed tokenId, uint256 indexed blockNumber, string memo)
func (_Baas721 *Baas721Filterer) WatchTransactionMemo(opts *bind.WatchOpts, sink chan<- *Baas721TransactionMemo, tokenId []*big.Int, blockNumber []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Baas721.contract.WatchLogs(opts, "transactionMemo", tokenIdRule, blockNumberRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseTransactionMemo is a log parse operation binding the contract event 0x123392ef4dfc825252c018e5fdcbb56bd895e4f681eba5e936e164009a05f435.
//
// Solidity: event transactionMemo(uint256 indexed tokenId, uint256 indexed blockNumber, string memo)

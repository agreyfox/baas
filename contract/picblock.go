...
func (_Contract *ContractTransactor) Mint(opts *bind.TransactOpts, _tokenId *big.Int, _tokenUri string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "mint", _tokenId, _tokenUri)
}

// Mint is a paid mutator transaction binding the contract method 0x77097fc8.
//
// Solidity: function mint(uint256 _tokenId, string _tokenUri) returns()
func (_Contract *ContractSession) Mint(_tokenId *big.Int, _tokenUri string) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, _tokenId, _tokenUri)
}

// Mint is a paid mutator transaction binding the contract method 0x77097fc8.
//
// Solidity: function mint(uint256 _tokenId, string _tokenUri) returns()
func (_Contract *ContractTransactorSession) Mint(_tokenId *big.Int, _tokenUri string) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, _tokenId, _tokenUri)
}
